package com.pyjh.clothing.wxpay.hander;

import com.pyjh.clothing.wxpay.util.MD5Util;
import com.pyjh.clothing.wxpay.util.TenpayUtil;
...
public class RequestHandler {
    ...
    public String getRequestURL() throws UnsupportedEncodingException {
        ...
        System.out.println(this.getGateUrl() + "?" + reqPars + "uuuuuuuuuuuuuuuuuuuuuuuuuu");
